...
const url = '/api/v1/livro/tamanho';

let id = null;

describe('Testes das rotas de tamanho', ()=>{
    ...
    test('POST:422 nome inexistente', async ()=>{
        ...
        expect(resposta.body.msg).toContain("Nome do tamanho é obrigatório");
    });
    ...
    test('POST:201', async ()=>{
        ...
        expect(resposta.body.nome).toBe("Livro de Bolso");
